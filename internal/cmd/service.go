...
var serviceCmd = &cobra.Command{
	...
	Long:  `service manages mini-me as a macOS Launchd background daemon / Homebrew service running 'mini-me serve' on startup.`,
}

var serviceInstallCmd = &cobra.Command{
	Use:   "install",
	Short: "Install and start mini-me background service on macOS",
